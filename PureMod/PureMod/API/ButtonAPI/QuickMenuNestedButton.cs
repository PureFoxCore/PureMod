...
{
    public class QuickMenuNestedButton
    {
        public string menuName { get; private set; }
        public QuickMenuSingleButton mainButton;
        ...
        public QuickMenuNestedButton(QuickMenuNestedButton buttonMenu, int xLocation, int yLocation, string text, string toolTip, Color? mainTextColor = null, Color? mainBackgroundColor = null, Color? backTextColor = null, Color? backBackgroundColor = null)
        {
        ...
        public QuickMenuNestedButton(QuickMenuNestedHalfButton buttonMenu, int xLocation, int yLocation, string text, string toolTip, Color? mainTextColor = null, Color? mainBackgroundColor = null, Color? backTextColor = null, Color? backBackgroundColor = null)
        {
            buttonQuickMenuLocation = buttonMenu.menuName;
            initializeButton(xLocation, yLocation, text, toolTip, mainTextColor, mainBackgroundColor, backTextColor, backBackgroundColor);
        }

        public QuickMenuNestedButton(string buttonMenu, int xLocation, int yLocation, string text, string toolTip, Color? mainTextColor = null, Color? mainBackgroundColor = null, Color? backTextColor = null, Color? backBackgroundColor = null)
        {
            buttonQuickMenuLocation = buttonMenu;
            initializeButton(xLocation, yLocation, text, toolTip, mainTextColor, mainBackgroundColor, backTextColor, backBackgroundColor);
        }

        public QuickMenuNestedButton(QuickMenuNestedButton buttonMenu, int xLocation, int yLocation, string text, string toolTip, Action action, Color? mainTextColor = null, Color? mainBackgroundColor = null, Color? backTextColor = null, Color? backBackgroundColor = null)
        {
            buttonQuickMenuLocation = buttonMenu.menuName;
        ...
        public QuickMenuNestedButton(QuickMenuNestedHalfButton buttonMenu, int xLocation, int yLocation, string text, string toolTip, Action action, Color? mainTextColor = null, Color? mainBackgroundColor = null, Color? backTextColor = null, Color? backBackgroundColor = null)
        {
            buttonQuickMenuLocation = buttonMenu.menuName;
            initializeButton(xLocation, yLocation, text, toolTip, mainTextColor, mainBackgroundColor, backTextColor, backBackgroundColor, action);
        }

        public QuickMenuNestedButton(string buttonMenu, int xLocation, int yLocation, string text, string toolTip, Action action, Color? mainTextColor = null, Color? mainBackgroundColor = null, Color? backTextColor = null, Color? backBackgroundColor = null)
        {
            buttonQuickMenuLocation = buttonMenu;
            initializeButton(xLocation, yLocation, text, toolTip, mainTextColor, mainBackgroundColor, backTextColor, backBackgroundColor, action);
        }
        ...
        private void initializeButton(int xLocation, int yLocation, string text, string toolTip, Color? mainTextColor = null, Color? mainBackgroundColor = null, Color? backTextColor = null, Color? backBackgroundColor = null, Action action = null)
        {
            ...
            mainButton = new QuickMenuSingleButton(buttonQuickMenuLocation, xLocation, yLocation, text, delegate ()
            {
                if (action != null)
                    action.Invoke();
