...
namespace PureMod.API.ButtonAPI
{
    public class QuickMenuToggleButton : QuickMenuButtonBase
    {
        ...
        public QuickMenuToggleButton(QuickMenuNestedButton buttonMenu, int xLocation, int yLocation, string text, string toolTip, Action<bool> action, Color textColorOn, Color textColorOff, bool state = false, Color? backgroundColor = null)
        {
        ...
        public QuickMenuToggleButton(QuickMenuNestedHalfButton buttonMenu, int xLocation, int yLocation, string text, string toolTip, Action<bool> action, Color textColorOn, Color textColorOff, bool state = false, Color? backgroundColor = null)
        {
            buttonQuickMenuLocation = buttonMenu.menuName;
            initializeButton(xLocation, yLocation, text, toolTip, action, state, textColorOn, textColorOff, backgroundColor);
        }

        public QuickMenuToggleButton(string buttonMenu, int xLocation, int yLocation, string text, string toolTip, Action<bool> action, Color textColorOn, Color textColorOff, bool state = false, Color? backgroundColor = null)
        {
