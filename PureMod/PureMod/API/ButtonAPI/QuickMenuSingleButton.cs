...
{
    public class QuickMenuSingleButton : QuickMenuButtonBase
    {
        public QuickMenuSingleButton(QuickMenuNestedButton buttonMenu, int xLocation, int yLocation, string text, Action action, string toolTip, Color? backgroundColor = null, Color? textColor = null)
        {
        ...
        public QuickMenuSingleButton(QuickMenuNestedHalfButton buttonMenu, int xLocation, int yLocation, string text, Action action, string toolTip, Color? backgroundColor = null, Color? textColor = null)
        {
            buttonQuickMenuLocation = buttonMenu.menuName;
            initializeButton(xLocation, yLocation, text, action, toolTip, backgroundColor, textColor);
        }

        public QuickMenuSingleButton(string buttonMenu, int xLocation, int yLocation, string text, Action action, string toolTip, Color? backgroundColor = null, Color? textColor = null)
        {
