...
namespace PureMod.Addons
{
    public class QMmenu : ModBase
    {
        ...
        public override void OnStart()
        {
            ...
            userMenuP2 = new NestedButton(userMenuP1.GetMenuName(), 5, 4, true, "Page 2", "User Utils Menu Page 2");
            userMenuP3 = new NestedButton(userMenuP2.GetMenuName(), 5, 4, true, "Page 3", "User Utils Menu Page 3");
        }
